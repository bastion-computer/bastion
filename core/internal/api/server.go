...
func NewRouter(db *database.Client, logger *slog.Logger, opts ...RouterOption) *gin.Engine {
	...
	environmentRoutes.GET("/by-key/:key/tunnels", environmentHandler.Tunnels)
	...
	environmentRoutes.Any("/by-key/:key/tunnels/:name", environmentHandler.TunnelProxy)
	environmentRoutes.Any("/by-key/:key/tunnels/:name/*path", environmentHandler.TunnelProxy)
	environmentRoutes.POST("/:id/ssh", environmentHandler.SSH)
	environmentRoutes.GET("/:id/tunnels", environmentHandler.Tunnels)
	...
	environmentRoutes.Any("/:id/tunnels/:name", environmentHandler.TunnelProxy)
	environmentRoutes.Any("/:id/tunnels/:name/*path", environmentHandler.TunnelProxy)
