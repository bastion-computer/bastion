...
func NewRouter(db *database.Client, logger *slog.Logger, opts ...RouterOption) *gin.Engine {
	...
	environmentRoutes.Any("/by-key/:key/tunnel/:name", environmentHandler.TunnelProxy)
	environmentRoutes.Any("/by-key/:key/tunnel/:name/*path", environmentHandler.TunnelProxy)
	...
	environmentRoutes.Any("/:id/tunnel/:name", environmentHandler.TunnelProxy)
	environmentRoutes.Any("/:id/tunnel/:name/*path", environmentHandler.TunnelProxy)
