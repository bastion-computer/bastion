...
| Category                                             | Actions                    |
| ---------------------------------------------------- | -------------------------- |
| [Coding agents](/ecosystem/built-ins/coding-agents/) | `setup_opencode`           |
| [Utility tools](/ecosystem/built-ins/utility-tools/) | `setup_github_cli`         |
| [Runtimes](/ecosystem/built-ins/runtimes/)           | `setup_node`, `setup_mise` |
